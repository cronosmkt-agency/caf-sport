...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Caf Sport Academia — Musculação & Treinamento | São Pedro, Teresópolis" },
      { name: "description", content: "Musculação completa, acompanhamento com personal na sala, som motivador e mensalidade justa em São Pedro, perto do posto de gasolina." },
      { property: "og:title", content: "Caf Sport Academia — São Pedro, Teresópolis" },
      { property: "og:description", content: "Treine com acompanhamento de verdade e clima tranquilo perto de você." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
    ],
    links: [
      { rel: "stylesheet", href: appCss },
      { rel: "icon", type: "image/svg+xml", href: "data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'><rect width='100' height='100' rx='25' fill='%23ffffff'/><rect x='4' y='4' width='92' height='92' rx='21' fill='none' stroke='%2316a34a' stroke-width='6'/><text x='50%' y='55%' text-anchor='middle' dominant-baseline='middle' fill='%2316a34a' font-family='sans-serif' font-weight='900' font-size='36'>CAF</text></svg>" },
