...
export default function ClientLandingPage() {
  ...
  const [selectedService, setSelectedService] = useState("Emagrecimento & Perda de Gordura");
  const [notes, setNotes] = useState("");

  const phone = "5521999255765";
  const phoneDisplay = "(21) 99925-5765";
  const address = "R. Luís Noguet Júnior, 467 - Bairro de São Pedro, Teresópolis - RJ (Próximo ao Posto de Gasolina de São Pedro)";
...
${notes ? `*Observações:* ${notes}` : ""}`;
  ...
  const services = [["Musculação Completa", "Treino de força orientado para hipertrofia, postura e ganho de massa magra.", "Força"], ["Acompanhamento com Personal", "Fichas de treino adaptadas ao seu objetivo com correção constante de movimento.", "Personal"], ["Condicionamento Aeróbico", "Área cardio equipada para queima de gordura e saúde do coração.", "Cardio"], ["Aulas Experimentais Gratuitas", "Venha treinar um dia com a gente para conhecer nossa estrutura e nossa equipe.", "Free Pass"]];
  const features = [["Dumbbell", "Musculação & Hipertrofia", "Pesos livres, halteres emborrachados e máquinas para todos os grupos musculares."], ["Activity", "Cardio & Emagrecimento", "Esteiras e ergométricas para acelerar a queima calórica e condicionamento."], ["Award", "Preço Justo Sem Pegadinhas", "Planos mensais e trimestrais sem multas absurdas ou taxas ocultas."]];
  const testimonials = [["Laura Alves Lins (Local Guide)", "Bem localizada, bom preço e disponibilidade de personal pra treino! Bom gosto musical também! Recomendo ++", 5], ["Fabiana Esteves (Local Guide)", "Treino lá atualmente e gostei muito! Ambiente agradável e acolhedor.", 5], ["Jorge Barcelos (Local Guide)", "Excelente localização próximo ao posto de gasolina São Pedro. Super recomendo!", 5]];
  const stats = [["06h - 22h", "Horário Estendido"], ["São Pedro", "Localização Fácil"], ["100%", "Suporte na Sala"]];
  const faq = [["Como funciona a aula experimental?", "Basta clicar em resgatar pelo WhatsApp e agendar o dia que prefere treinar. Você não paga nada no seu primeiro dia!"], ["Quais são as formas de pagamento?", "Aceitamos Pix, cartões de crédito e débito com opções de planos mensais e trimestrais facilitados."], ["Onde fica a academia?", "Na Rua Luís Noguet Júnior, 467, São Pedro (bem próximo ao Posto de Gasolina)."]];
  const simulatorOptions = ["Emagrecimento & Perda de Gordura", "Hipertrofia & Ganho de Massa Muscular", "Saúde, Disposição & Condicionamento", "Conhecer a Academia (Passe Livre)"];
  const reassuranceItems = [["Personal na Sala", "Professores disponíveis para orientar exercícios e montar sua ficha."], ["Sem Filas de Rede", "Ambiente ventilado e tranquilo para treinar no seu ritmo sem estresse."], ["Horário Amplo", "Aberto das 06h às 22h para quem treina cedo ou após o trabalho."]];
      ...
      <header className="sticky top-0 z-50 border-b border-zinc-800/80 bg-[#09090b]/95 backdrop-blur-md">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          <a href="#" className="flex items-center gap-3">
            <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-zinc-800 text-yellow-400 border border-yellow-400/50 shadow-md">
              {renderIcon("Dumbbell")}
            </div>
            <div>
          ...
          <div className="grid items-center gap-12 lg:grid-cols-12">
            ...
            <div className="lg:col-span-7">
              <div className="inline-flex items-center gap-2 rounded-full border border-border bg-secondary px-4 py-1.5 text-xs font-semibold text-foreground">
                ...
                ⭐ 4,3 com 54 Avaliações · Ao lado do Posto São Pedro · Das 06h às 22h
              </div>

              <h1 className="mt-6 text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl">
                Treine com acompanhamento de verdade e clima tranquilo <span className="text-accent underline decoration-accent/30 underline-offset-8">no coração de São Pedro.</span>
              </h1>

              <p className="mt-6 text-lg leading-relaxed text-muted-foreground sm:text-xl">
                Aparelhos completos, professores atenciosos corrigindo sua postura, som motivador e mensalidades sem taxas abusivas ao lado do Posto São Pedro.
              </p>
              ...
              <div className="mt-8 flex items-center gap-4 border-t border-border pt-6">
                ...
                <div>
                  <p className="text-sm font-bold text-foreground">
                    4.3 Estrelas · 4,3 no Google Avaliações
                  </p>
                  <p className="text-xs text-muted-foreground">54 avaliações · Melhor custo-benefício de São Pedro</p>
                </div>
              </div>
            </div>
              ...
              <div className="rounded-3xl border border-zinc-800 bg-zinc-900/90 p-8 shadow-2xl backdrop-blur-sm">
                <div className="flex items-center justify-between border-b border-border pb-5">
                  <div className="flex items-center gap-3">
                    <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-zinc-800 text-yellow-400 border border-yellow-400/50">
                      {renderIcon("Dumbbell")}
                    </div>
                    <div>
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="text-center">
            ...
            <p className="mt-2 text-3xl font-extrabold tracking-tight text-white sm:text-4xl">
              Vantagens de Treinar na Caf Sport
            </p>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="text-center">
            ...
            <p className="mt-4 text-base text-zinc-400">
              Tudo o que você precisa para alcançar sua melhor versão física
            </p>
          </div>
          ...
          <div className="grid items-center gap-12 lg:grid-cols-12">
            <div className="lg:col-span-6">
              <div className="relative rounded-3xl border border-zinc-800 bg-gradient-to-br from-zinc-900 to-zinc-950 p-10 text-center">
                <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-3xl bg-zinc-800 text-yellow-400 border border-yellow-400/50 shadow-xl">
                  {renderIcon("Dumbbell")}
                </div>
                <h4 className="mt-5 text-2xl font-bold text-foreground">Caf Sport Academia</h4>
                <p className="mt-1 text-xs font-semibold tracking-wider text-muted-foreground uppercase">
                  Academia Completa em São Pedro · R. Fileuterpe
                </p>
            ...
            <div className="lg:col-span-6">
              ...
              <p className="mt-2 text-3xl font-extrabold tracking-tight text-white sm:text-4xl">
                Sua Academia em São Pedro
              </p>
              <p className="mt-6 text-base leading-relaxed text-muted-foreground">
                A Caf Sport nasceu para oferecer aos moradores de São Pedro uma alternativa de treino acolhedora, perto de casa e sem a impessoalidade das grandes franquias.
              </p>
              <p className="mt-4 text-base leading-relaxed text-muted-foreground">
                Aqui você não é apenas mais um número de catraca: os professores conhecem seus objetivos e estão prontos para ajudar você a evoluir todos os dias.
              </p>
          ...
          <div className="rounded-3xl border border-zinc-800 bg-zinc-900 p-8 shadow-2xl sm:p-12">
            <div className="text-center">
              ...
              <h2 className="mt-4 text-3xl font-extrabold text-foreground sm:text-4xl">
                Garanta Seu 1º Dia de Treino Grátis
              </h2>
              <p className="mt-2 text-base text-muted-foreground">
                Preencha para resgatar sua aula experimental no WhatsApp:
              </p>
            </div>
      ...
      <footer className="border-t border-zinc-900 bg-black py-12 text-zinc-400">
        <div className="mx-auto max-w-7xl px-6">
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            <div>
              <div className="flex items-center gap-3">
                <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-zinc-800 text-yellow-400 border border-yellow-400/50">
                  {renderIcon("Dumbbell")}
                </div>
                <span className="text-lg font-bold text-white">Caf Sport Academia</span>
              </div>
              <p className="mt-3 text-xs leading-relaxed text-muted-foreground">
                Musculação completa, acompanhamento com personal na sala, som motivador e mensalidade justa em São Pedro, perto do posto de gasolina.
              </p>
            </div>
          ...
          <div className="mt-12 border-t border-border pt-6 text-center text-xs text-muted-foreground">
            © {new Date().getFullYear()} Caf Sport Academia · Todos os direitos reservados · Desenvolvimento e Performance por Cronos Agency
          </div>
        </div>
      </footer>
